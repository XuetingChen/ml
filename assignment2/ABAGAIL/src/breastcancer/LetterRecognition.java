...
public class LetterRecognition {
    ...
    private static int inputLayer = 16, hiddenLayer = 5, outputLayer = 1, trainingIterations = 1;
    ...
    private static Instance[] initializeInstances() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/test/letter-recognition.csv")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][1][0] = ((int) scan.next().charAt(0)) - 65;
